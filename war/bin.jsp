...
<head>
    ...
    <style>
    .scroll-content-item { float: left; display: inline; cursor: pointer; padding-top:2px; width: 70px; height: 95px; float: left; margin: 20px; font-size:10px;  font-family: arial ; color:#000000;  background-color:#eeeeee; text-align: center; font-weight: normal; line-height: 10px;}
...
<a href="javascript:showPrototype();" style="font-size: large; color: blue;"> Click here to express your opinion about this movie</a>
</div>

<div id="mainBody">
<div style="margin-right:20%; margin-left:20%; height:30px; background-color:#ffff44; text-align: center;" id="status"></div> 

    <div id="direct" style="font-size: medium; margin-top: 15px; background-color: #ffffaa;">INSTRUCTIONS: Click on the movie you like more.</div>
