...
<p>&nbsp;</p>    
<div id="examplesList" style="margin-top: 220px;">
    <c:forEach items="${ratings}"  var="rating" varStatus="loop">
		
	<div class="scroll-content-item" style="margin-left:2px; float:left; background-color: #eeeeee"><img src="/img/${rating.movieId}.jpg"/><div style="" >${rating.movieName}</div></div>
